...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(v -> startActivity(new Intent(MainActivity3.this,MainActivity2.class)));
...
//                    String date=simpleDateFormat.format(calendar.getTime());
                    ...
                    JSONObject rr=ap.getJSONObject(2);
                    Log.d("hiii","byee");
                    ...
                    Glide.with(MainActivity3.this).load(temp).into(imageView);

                    ArrayAdapter adapter = new ArrayAdapter<String>(MainActivity3.this,
