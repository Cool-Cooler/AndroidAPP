...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(v -> startActivity(new Intent(MainActivity2.this,MainActivity3.class)));
        prev=findViewById(R.id.Previous);
        prev.setOnClickListener(v -> startActivity(new Intent(MainActivity2.this,MainActivity.class)));
...
//                    String date=simpleDateFormat.format(calendar.getTime());
                    ...
                    JSONObject rr=ap.getJSONObject(1);
                    Log.d("hiii","byee");
                    ...
                    Glide.with(MainActivity2.this).load(temp).into(imageView);
